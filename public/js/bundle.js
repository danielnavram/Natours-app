...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFuaWVsbmF2cmFtIiwiYSI6ImNrMWJlM3RqZDJteDkzYnFkd3MxcjczOXYifQ.cLFCZduedrnFjNfLgw_x9Q';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', "".concat(type.toUpperCase(), " have been updated succesfully!"));
            }
...
if (updatePassword) updatePassword.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
